...
function studentGradeGenerator() {
  var score = prompt('Enter the students marks between 0 and 100'); // Checks the grade based on the input score
  ...
  console.log(" The grade for ".concat(score, " is ").concat(grade));
} //Invoke the function
